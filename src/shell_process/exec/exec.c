...
// /*   Updated: 2025/09/14 22:46:07 by sberete          ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// /* ───────── redirs + builtins en parent (argvx déjà expansé,
// 	sans fuite de FDs) ───────── */
// static int	run_builtin_in_parent_with_redirs(t_ast *cmd, char **argvx,
// 		t_data *data)
// {
// 	int	saved_in;
// 	int	saved_out;
...
// 		return (1);
// 	/* Préparer les heredocs avant touchers aux flux (déjà fait,
// 		mais ici on les ouvre) */
